...
This is a valuable step to validate policy behaviour before applying changes to a live project.
...
- Start with **Log Only** mode to monitor behaviour without disruption.
...
<CardGroup cols={2}>
  ...
  >
    Analyse policy violation data and performance trends.
  </Card>
  <Card
    title="Manage Users"
    icon="user-gear"
