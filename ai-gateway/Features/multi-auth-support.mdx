---
title: Multi Auth (Azure OpenAI)
description: Multi Auth for Azure OpenAI provides enterprise grade flexibility in authentication methods, enabling organisations to seamlessly integrate with Azure OpenAI services using their preferred security protocols.
...
<Columns cols={3}>
  <Card
    ...
    icon="link"
    href="https://docs.microsoft.com/azure/cognitive-services/openai/"
    arrow="true"
    cta="View Documentation"
  >
    Comprehensive documentation for Azure OpenAI services, including setup guides, API references, and best practices for integrating with Azure's AI services.
  </Card>
  ...
  <Card
    ...
    cta="Learn More"
  >
    Official Microsoft documentation for Azure Active Directory authentication, covering identity management, single sign-on, and security features.
  </Card>

  <Card
    title="Managed Identity Overview"
    icon="link"
    href="https://docs.microsoft.com/azure/active-directory/managed-identities-azure-resources/"
    arrow="true"
    cta="Get Started"
  >
    Learn about Azure Managed Identities for secure, automatic authentication between Azure services without managing credentials.
  </Card>
</Columns>
