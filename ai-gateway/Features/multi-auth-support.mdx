---
title: Multi-Authentication Support for Azure OpenAI
description: The AI Gateway's Multi-Authentication Support for Azure OpenAI provides enterprise-grade flexibility in authentication methods, enabling organizations to seamlessly integrate with Azure OpenAI services using their preferred security protocols. This feature supports three distinct authentication modes - API Key, Azure Entra ID (formerly Azure AD), and Managed Identity - ensuring compatibility with diverse enterprise security architectures and compliance requirements.
---

## Overview

Multi-Authentication Support represents a critical enterprise feature that enables organizations to adopt Azure OpenAI services while maintaining their existing security posture and compliance requirements. This feature eliminates the traditional "one-size-fits-all" authentication approach, providing flexibility to choose the most appropriate authentication method based on specific use cases, security requirements, and deployment environments.

### Key Capabilities

<Columns cols={2}>
  <Card title="Three Authentication Modes" icon="shield">
    Comprehensive support for API Key, Azure Entra ID, and Managed Identity authentication.
  </Card>
  <Card title="Seamless Switching" icon="refresh-cw">
...
Azure Entra ID (formerly Azure Active Directory) authentication provides enterprise-grade security through OAuth 2.0 client credentials flow, enabling advanced features like conditional access policies, multi-factor authentication enforcement, and centralized identity management.
...
- **Identity Governance**: Centralized access reviews and certification campaigns
...
- **Centralized Administration**: Single point of control for all authentication
...
- **Optimized Network Traffic**: Fewer round trips for authentication
...
- **Risk**: Unauthorized access to higher privileges
...
- **Prevention**: Use regional endpoints and optimize network path
...
- Azure Support for enterprise customers

---

## Conclusion

Multi-Authentication Support for Azure OpenAI in the AI Gateway represents a comprehensive solution for enterprise authentication requirements. By supporting API Key, Azure Entra ID, and Managed Identity authentication methods, organizations can choose the optimal security approach for their specific needs while maintaining operational efficiency and compliance requirements.
