...
<CardGroup cols={2}>
  <Card
    title="50+ Production Models"
    description="From lightweight to state-of-the-art models across all providers."
  />
  <Card
    title="Automatic Model Validation"
    description="Built-in validation ensures only supported models are used."
  />
  <Card
    title="Model-Specific Optimizations"
    description="Automatic parameter adjustments based on model capabilities."
  />
  <Card
    title="Transparent Pricing"
    description="Real-time cost calculation for all supported models."
  />
</CardGroup>
