...
| Mistral Large 3 (`mistral.mistral-large-3-675b-instruct`)          | Latest large Mistral model with enhanced reasoning capabilities. | 2025             | Text, Code, Reasoning      | –                  | –                     | –                     |
...
| Ministral 3B (`mistral.ministral-3-3b-instruct`)                   | Lightweight Ministral 3B instruction-tuned model.                | 2025             | Text                       | –                  | –                     | –                     |
| Ministral 3 8B (`mistral.ministral-3-8b-instruct`)                 | Medium-sized Ministral 3 8B instruction-tuned model.             | 2025             | Text                       | –                  | –                     | –                     |
| Ministral 14B (`mistral.ministral-3-14b-instruct`)                 | Large Ministral 3 14B instruction-tuned model.                  | 2025             | Text                       | –                  | –                     | –                     |
| Magistral Small 2509 (`mistral.magistral-small-2509`)              | Compact Magistral model optimized for efficiency.                 | 2025-09          | Text                       | –                  | –                     | –                     |
| Voxtral Small 24B 2507 (`mistral.voxtral-small-24b-2507`)         | Small Voxtral 24B model optimized for voice and text tasks.      | 2025-07          | Text                       | –                  | –                     | –                     |
| Voxtral Mini 3B 2507 (`mistral.voxtral-mini-3b-2507`)              | Ultra-lightweight Voxtral 3B model for fast inference.           | 2025-07          | Text                       | –                  | –                     | –                     |
| Gemma 3 4B IT (`google.gemma-3-4b-it`)                             | Google Gemma 3 4B instruction-tuned model.                      | 2025             | Text                       | –                  | –                     | –                     |
| Gemma 3 12B IT (`google.gemma-3-12b-it`)                           | Google Gemma 3 12B instruction-tuned model.                       | 2025             | Text                       | –                  | –                     | –                     |
| Gemma 3 27B IT (`google.gemma-3-27b-it`)                           | Google Gemma 3 27B instruction-tuned model.                      | 2025             | Text                       | –                  | –                     | –                     |
| Kimi K2 Thinking (`moonshot.kimi-k2-thinking`)                       | Moonshot Kimi K2 reasoning model optimized for complex thinking tasks. | 2025             | Text                       | –                  | –                     | –                     |
