...
<Steps>
  <Step title="Navigate to Guardrail Configuration">
    Go to your project dashboard and select <strong>Configure Guardrails</strong>.
  </Step>
  ...
  <Step title="Save and Test">
    Save your changes and use the <strong>Test Guardrails</strong> tab to validate protection behavior.
  </Step>
</Steps>
...
<Steps>
  ...
  <Step title="Save and Test">
    Save your changes and use the <strong>Test Guardrails</strong> tab to validate filter behavior.
  </Step>
</Steps>
...
Filter out specific words and phrases from prompts and responses to enforce custom content guardrails.
...
Prevent discussion or generation of content on restricted topics, ensuring compliance with organizational guardrails.
