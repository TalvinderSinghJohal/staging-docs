...
<Columns cols={2}>
  ...
  <Card title="Strategic Flexibility">
...
```json
{
  "metadata": {
    ...
    "team": {
      "team_id": "string (max 64)",
      "team_name": "string (max 128)"
    },
    "tenant": {
      "tenant_id": "string (max 64)",
      "tenant_name": "string (max 128)",
      "tenant_user": {
        "tenant_user_id": "string (max 64)",
        "tenant_user_name": "string (max 128)",
        "tenant_user_email": "string (valid email)",
        "tenant_user_role": "string (max 64)"
      }
    }
  }
}
...
response = client.chat.completions.create(
    ...
    metadata={
        ...
        "tenant": {
            ...
            "tenant_user": {
                "tenant_user_id": "tenant_user_123",
                "tenant_user_name": "John Doe",
                "tenant_user_email": "john.doe@acme.com",
