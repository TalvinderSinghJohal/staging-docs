...
<callout type="info">
The Unified API exposes a single, OpenAI-compatible endpoint for accessing 7 major AI providers. This eliminates vendor lock-in and streamlines integration—no code changes required to switch providers.
</callout>
