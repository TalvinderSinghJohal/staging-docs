...
```bash request.sh lines icon="bash"
curl -X GET https://gateway.altrum.ai/
```

You should receive a response like:

```json response.json lines icon="json"
{
...
```bash chat-completion-request.sh lines icon="bash"
...
```json chat-completion-response.json lines icon="json"
{
  "id": "chatcmpl-123",
...
```bash anthropic-request.sh lines icon="bash"
curl -X POST https://gateway.altrum.ai/v1/chat/completions \
  -H "Content-Type: application/json" \
...
```bash google-gemini-request.sh lines icon="bash"
curl -X POST https://gateway.altrum.ai/v1/chat/completions \
  -H "Content-Type: application/json" \
...
```bash streaming-request.sh lines icon="bash"
curl -X POST https://gateway.altrum.ai/v1/chat/completions \
  -H "Content-Type: application/json" \
...
```json streaming-response.json lines icon="json"
...
```bash multi-model-test.sh lines icon="bash"
# Test with GPT-4o
curl -X POST https://gateway.altrum.ai/v1/chat/completions \
  -H "Content-Type: application/json" \
  -H "Authorization: Bearer your-openai-api-key" \
...
```bash troubleshooting.sh lines icon="bash"
