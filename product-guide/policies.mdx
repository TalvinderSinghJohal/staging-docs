...
- Select relevant **Topics, Entities, or Regulations** (depending on the policy type).
 ...
 _For detailed instructions on each policy type, refer to the **Policy** section of the documentation._
...
1. Return to the **Configure Policies** tab.
2. Click **Apply Policies** to activate the changes across your project.
3. You will receive a success message confirming that policies are now enforced.
...
1. From the **Configure Policies** tab, click the policy you wish to update.
2. Modify any settings as needed.
3. Toggle the **Enable** switch to turn the policy on or off.
