...
#### Detailed Policy Violations Logs

The **Policy Violation Logs** table within the Project Reporting page allows you to review all policy violation events for the selected project.
