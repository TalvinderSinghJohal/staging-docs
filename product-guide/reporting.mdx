...
Selecting a timeframe will automatically update the organisation-wide statistics and visualisations.
...
- **Policy Violations**
  - Counts and categories of violations across different policies
- **Violation Trends**
  - Time-series graphs displaying how violation incidents change over time

These insights allow both proactive adjustments and retrospective analysis.

![Screenshot: Metrics dashboard view]

---

## Exporting Reports (Coming Soon)

🚧 Export functionality to download reports as **CSV** or **PDF** files is planned for a future release.
