...
---
<Update label="v1.3.0 - Latest Release" description="Latest Release">
  ## Improvements

  ### Prompt Injections Guardrail Enhancements
  - Improved accuracy of **Prompt Injectiosn** guardrail for more reliable protection against prompt attacks
  - Enhanced detection capabilities ensure better identification and prevention of injection attempts
  ...
  - Improved overall system efficiency and responsiveness for better user experience
</Update>
