...
<Update label="June 2025" description="v1.0.0">
  **Enhanced Guardrail Violation Logs in Reporting**
  - The Guardrail Violation Logs table within the Project Reporting page now provides deeper insights and easier investigation of guardrail violations.
  - Expand any record in the Guardrail Violation Logs table for more details. Click the eye icon on a row to open a slider panel from the right side of the screen.
