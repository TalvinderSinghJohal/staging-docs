...
2. **Deterministic Enforcement**  
   - Set to **Block** behaviour for immediate protection
   - Provides clear error messages when custom patterns are detected
...
```
Pattern: (?:ACC|REF|EMP)-\d{4}-\d{4}-\d{4}
Matches: ACC-1234-5678-9012, REF-9876-5432-1098, EMP-1111-2222-3333
Description: Multiple prefix formats with same number pattern
```

#### Conditional Patterns
```
Pattern: (?:UK|US|CA)-\d{2}[A-Z]{2}\d{4}
Matches: UK-12AB3456, US-34CD7890, CA-56EF1234
Description: Country-specific identifier format
```
