...
### Step 7: Save, Test, and Apply the Guardrail
...
- **Low** threshold for strict exact matching with minimal false positives
- **High** threshold for comprehensive filtering including contextual variations
