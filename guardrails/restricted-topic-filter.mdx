...
### Creating Effective Denied Topics

When defining denied topics, follow these best practices for optimal detection accuracy:
...
- Include up to 5 example phrases (max 100 characters each)
- Provide real-world examples of what should be filtered
- Examples: "Is investing in stocks better than bonds?", "Should I invest in gold?"
