...
![Screenshot: Access Competitor Mention policy workflow](#)
...
![Screenshot: Enable Competitor Mention policy](#)

---

### Step 3: Add Competitor Names and Variations
...
📌 This allows you to detect and manage references to direct competitors across user input and AI output.

![Screenshot: Competitor name input and tag list](#)
...
![Screenshot: Save and apply actions](#)
