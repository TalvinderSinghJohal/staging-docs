...
![Screenshot: Access policy configuration](#)
...
![Screenshot: Enable RAG Hallucinations Policy](#)
...
![Screenshot: Behaviour selection - Log Only or Log and Override](#)
...
![Screenshot: Save, test, and apply flow](#)
